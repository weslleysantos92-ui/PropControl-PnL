    ...
    extend: {
      colors: {
        ...
        premium: {
          ...
          goldRing: 'rgba(212, 175, 55, 0.3)',
          goldText: '#D4AF37',
          funded: '#2ECC71',
          fundedSoft: 'rgba(46, 204, 113, 0.08)',
          fundedRing: 'rgba(46, 204, 113, 0.3)',
          fundedText: '#2ECC71',
          aqua: '#3B82F6',
          aquaSoft: 'rgba(59, 130, 246, 0.08)',
          aquaRing: 'rgba(59, 130, 246, 0.3)',
          aquaText: '#3B82F6',
          white: '#F5F5F5',
          muted: '#9CA3AF',
        },
