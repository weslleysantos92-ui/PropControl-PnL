  ...
  theme: {
    extend: {
      colors: {
        ...
        size10: {
          DEFAULT: '#2563eb', soft: 'rgba(37, 99, 235, 0.14)', ring: 'rgba(37, 99, 235, 0.42)', text: '#60a5fa',
        },
        size25: {
          DEFAULT: '#3b82f6', soft: 'rgba(59, 130, 246, 0.14)', ring: 'rgba(59, 130, 246, 0.35)', text: '#60a5fa',
        },
        size25c: {
          DEFAULT: '#06b6d4', soft: 'rgba(6, 182, 212, 0.14)', ring: 'rgba(6, 182, 212, 0.42)', text: '#22d3ee',
        },
        size50: {
          DEFAULT: '#a855f7', soft: 'rgba(168, 85, 247, 0.14)', ring: 'rgba(168, 85, 247, 0.35)', text: '#c084fc',
        },
        size100: {
          DEFAULT: '#f59e0b', soft: 'rgba(245, 158, 11, 0.14)', ring: 'rgba(245, 158, 11, 0.35)', text: '#fbbf24',
        },
        size150: {
          DEFAULT: '#10b981', soft: 'rgba(16, 185, 129, 0.14)', ring: 'rgba(16, 185, 129, 0.35)', text: '#34d399',
        },
