...
export function NewAccountModal({open,onClose}:{open:boolean;onClose:()=>void}){
 ...
 return <Modal open={open} onClose={onClose} title="Nova Conta"><div className="space-y-5">
  ...
  <button onClick={save} disabled={!name.trim()||!code.trim()||!firm||!program} className="w-full rounded-2xl border border-[#D4AF37]/50 bg-[#D4AF37]/[0.06] py-3.5 font-bold text-[#D4AF37] disabled:cursor-not-allowed disabled:opacity-40">Cadastrar Conta</button>
 </div></Modal>;
}
